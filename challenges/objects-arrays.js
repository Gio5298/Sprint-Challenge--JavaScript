...
const unisWithUni = graduates.filter(item => item.university === 'Uni');
...
population_value = zooAnimals.reduce((accumulator, currentValue) => accumulator + currentValue.population, 0);
populationTotal.push(population_value);
